...
public class RecruitServiceImpl implements RecruitService {
	...
	@Override
	public List<RecruitDTO> getRecruitAuthentication(int pageNo, int pageSize, int userNum){
		return mapper.recruitListAuthentication(pageNo, pageSize, userNum);
	}

	@Override
	public List<RecruitDTO> getRecruitListForUser(int userNum) {
		return mapper.getRecruitListForUser(userNum);
	}
